<section class="wsus__banner_3" style="background: url({{asset("user/assets/images/banner_3_bg.png")}});">
    <div class="row justify-content-between">
        ...
        <div class="col-xl-4 col-lg-6 wow fadeInRight">
            <div class="wsus__banner_3_img">
                <div class="img">
                    <img src="{{asset("user/assets/images/banner_3_img_1.png")}}" alt="Banner" class="img-fluid">
