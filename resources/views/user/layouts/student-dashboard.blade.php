                ...
                <div class="col-xl-9 col-md-8">
                    <div class="text-end">
                        <button class="btn btn-primary">
                            <a href="{{route('student.become-instructor')}}" style="color: #FFFFFF">
                                Become Instructor
                            </a>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                <td class="image">
                                                    <div class="image_category">
                                                        <img src="{{asset("user/assets/images/courses_3_img_1.jpg")}}"
                                                             alt="img"
                                            ...
                                            <tr>
                                                <td class="image">
                                                    <div class="image_category">
                                                        <img src="{{asset("user/assets/images/courses_3_img_2.jpg")}}"
                                                             alt="img"
                                                             class="img-fluid w-100">
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="image">
                                                    <div class="image_category">
                                                        <img src="{{asset("user/assets/images/courses_3_img_3.jpg")}}"
                                                             alt="img"
                                                             class="img-fluid w-100">
                                                    </div>
                                                </td>
