...
<nav class="navbar navbar-expand-lg main_menu main_menu_3">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="menu_category">
            <div class="icon">
                <img src="{{asset("user/assets/images/grid_icon.png")}}" alt="Category" class="img-fluid">
            </div>
            Category
            <ul>
                <li>
        ...
        <div class="right_menu">
            <div class="menu_search_btn">
                <img src="{{asset("user/assets/images/search_icon.png")}}" alt="Search" class="img-fluid">
            </div>
            @if(!Auth::user())
                <ul>
                <li>
                    <a class="menu_signin" href="#">
                            <span>
                                <img src="{{asset("user/assets/images/cart_icon_black.png")}}" alt="user" class="img-fluid">
                            </span>
                        <b>06</b>
                    </a>
                </li>
                <li>
                    <a class="admin" href="{{route('admin.login')}}">
                            <span>
                                <img src="{{asset("user/assets/images/user_icon_black.png")}}" alt="user" class="img-fluid">
                            </span>
                        admin
                    </a>
                </li>
                ...
                <li>
                    <a class="common_btn" style="margin-left: 10px;" href="{{route("register")}}">Sign UP</a>
                </li>
            </ul>
            @elseif(Auth::user())
                <ul>
