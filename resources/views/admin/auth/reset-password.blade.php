            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.password.store') }}" autocomplete="off" novalidate>
                    ...
                    <a href="javascript:" class="link-secondary" title="Show password" data-bs-toggle="tooltip"><!-- Download SVG icon from http://tabler-icons.io/i/eye -->
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon toggle-password-svg" width="24" height="24" viewBox="0 0 24 24"
                    ...
                    <div class="mb-2">
                        ...
                        <div class="input-group input-group-flat">
                            <input type="password" name="password-confirmation" class="form-control password-confirmation" placeholder="Your password"
                                   autocomplete="off" required>

                            <span class="input-group-text ">
                    <a href="javascript:" class="link-secondary" title="Show password" data-bs-toggle="tooltip"><!-- Download SVG icon from http://tabler-icons.io/i/eye -->
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon toggle-password-confirmation" width="24" height="24" viewBox="0 0 24 24"
                           stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round"
                           stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path
                              d="M10 12a2 2 0 1 0 4 0a2 2 0 0 0 -4 0"/><path
                              d="M21 12c-2.4 4 -5.4 6 -9 6c-3.6 0 -6.6 -2 -9 -6c2.4 -4 5.4 -6 9 -6c3.6 0 6.6 2 9 6"/></svg>
...
<!-- Libs JS -->
<!-- Tabler Core -->
<script src="{{asset("admin/asset/dist/js/tabler.min.js?1692870487")}}" defer></script>
<script src="{{asset("admin/asset//dist/js/demo.min.js?1692870487")}}" defer></script>
</body>
</html>
