                        ...
                        <table class="table">
                            ...
                            @forelse($courseCategories As $category)
                                <tr>
                                    ...
                                    @endif
                                    <td>
                                        <a href="{{route('admin.sub_course_category.index',$category)}}"
                                        class="btn-sm btn-warning text-warning">
                                            <i class="ti ti-list"></i>
                                        </a>
                                        <a href="{{route('admin.course-category.edit',$category)}}">Edit</a>
                                        <form action="{{ route('admin.course-category.destroy',$category)}}"
